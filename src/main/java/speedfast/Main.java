...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Pedido[] pedidos = {
            ...
            new PedidoComida(4, "Av. Vicuña Mackenna 820", 2.5),
            new PedidoEncomienda(5, "Calle Providencia 789", 3.0,
                    5.0, 25.0, 20.0, 35.0, true),
            new PedidoExpress(6, "Av. Las Condes 10450", 5.0)
        };
