...
La siguiente iteración amplía el sistema mediante interfaces para reservar, despachar, cancelar y consultar el historial de entregas. Esta implementación corresponde a la **Actividad Sumativa 1** y se encuentra en la carpeta [`../Semana 3/`](../Semana%203/).
...
2. Seleccionar **Open** y elegir la carpeta `Semana 2`.
